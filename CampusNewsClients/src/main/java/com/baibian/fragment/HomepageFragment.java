...
//    private static final int STATE_REFRESHING = 3;
    ...
    View HomepageFragment = inflater.inflate(R.layout.homepage_layout, container, false);
        mColumnHorizontalScrollView = (ColumnHorizontalScrollView) HomepageFragment.findViewById(R.id.mColumnHorizontalScrollView);
        mRadioGroup_content = (LinearLayout) HomepageFragment.findViewById(R.id.mRadioGroup_content);
        ll_more_columns = (LinearLayout) HomepageFragment.findViewById(R.id.ll_more_columns);
        rl_column = (RelativeLayout) HomepageFragment.findViewById(R.id.rl_column);
        button_more_columns = (ImageView) HomepageFragment.findViewById(R.id.button_more_columns);
        mViewPager = (ViewPager) HomepageFragment.findViewById(R.id.mViewPager);
        shade_left = (ImageView) HomepageFragment.findViewById(R.id.shade_left);
        shade_right = (ImageView) HomepageFragment.findViewById(R.id.shade_right);
...
//        top_progress = (ProgressBar) HomepageFragment.findViewById(R.id.top_progress);
    ...
    private HomepageFragment.OnRefreshListener mListener;

    public void setOnRefreshListener(HomepageFragment.OnRefreshListener listener) {
        mListener = listener;
    }
